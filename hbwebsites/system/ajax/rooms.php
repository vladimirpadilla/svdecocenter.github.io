<?php 
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>
                        ...
                        <button type='button' onclick='removed_room($row[id])' class='btn btn-danger shadow-none btn-sm'>
    ...
    if(isset($_POST['edit_room']))
    {
        ...
        $values = [$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['desc'],$frm_data['room_id']];
    ...
    if(isset($_POST['get_room_images']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            $thumb_btn = "<i class='bi bi-check-lg text-light bg-success px-2 py-1 rounded fs-5'></i>";
                ...
                $thumb_btn = "<button onclick='thumb_images($row[sr_no],$row[room_id])' class='btn btn-secondary shadow-none'>
            ...
            echo<<<data
                <tr class='align-middle'>
                    ...
                    <td>$thumb_btn</td>
                    <td>
                        <button onclick='rem_images($row[sr_no],$row[room_id])' class='btn btn-danger shadow-none'>
                            <i class='bi bi-trash'></i>
                        </button>
                    </td>
                </tr>
