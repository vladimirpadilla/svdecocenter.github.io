<div class="container-fluid bg-white mt-5">
    <div class="row">
      <div class="col-lg-4 p-4">
        <h3 class="h-font fw-bold bg-dark text-white p-3 m-0"><?php echo $settings_r['site_title'] ?></h3>
        <p>
          <?php echo $settings_r['site_about'] ?>
        </p>
      </div>
      <div class="col-lg-4 p-4">
        <h5 class="bg-dark text-white p-3 m-0">Links</h5>
      ...
      <div class="col-lg-4 p-4">
        <h5 class="bg-dark text-white p-3 m-0">Follow us</h5>
        <!-- <?php 
          echo<<<data
...
<h6 class="text-center bg-dark text-white p-1 m-0"><img src="images/about/logos.jpg"> Designed and Developed by CCT STUDENTS <img src="images/about/logo.jpg"></h6>
...
<script>
  ...
  forgot_form.addEventListener('submit', (e)=>{
    ...
    xhr.onload = function(){
      ...
      else if(this.reponseText == 'upd_failed'){
  ...
  book_form.addEventListener('submit', (e)=>{
    ...
    data.append('room_name',book_form.elements['room_name'].value);
    ...
    data.append('in',book_form.elements['in'].value);
    data.append('checkout',book_form.elements['checkout'].value);
    data.append('out',book_form.elements['out'].value);
    data.append('book','');
