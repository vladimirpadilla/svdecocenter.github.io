...
<body class="bg-light">
    ...
    <div class="text-end mb-4">
    <a href="generate_pdf.php" target="_blank" class='mt-2 btn btn-outline-primary btn-sm fw-bold shadow-none'>
    <i class='bi bi-file-earmark-arrow-down-fill'></i> Generate all bookings
    </a>

    <a href="generate_pdf.php?type=booking" target="_blank" class='mt-2 btn btn-outline-success btn-sm fw-bold shadow-none'>
